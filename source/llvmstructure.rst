...
.. figure:: ../Table/Table2_1.png
	:align: center

	Table 2.1  Cpu0 registers table
...
.. figure:: ../Fig/Fig2_2.png
	:align: center

	Fig 2.2: CPU0 three instruction formats

The following is the CPU0 processor's instruction table format

.. figure:: ../Table/Table2_2.png
	:align: center

	Table 2.2: CPU0 instruction table

In the second edition of CPU0_v2 we fill the following command:

.. figure:: ../Table/Table2_3.png
	:align: center

	Table 2.3  CPU0_v2 instruction table
...
.. figure:: ../Fig/Fig2_3.png
	:align: center

	Fig 2.3: CPU0 status register
...
.. figure:: ../Fig/Fig2_4.png
	...
	Fig 2.4  cpu0 ldi instruction

.. figure:: ../Fig/Fig2_5.png
	:align: center

	Fig 2.5  Mips addiu instruction format
...
.. figure:: ../Fig/Fig2_6.png
	:align: center

	Fig 2.6  Tree major components of a Three Phase Compiler
...
.. figure:: ../Fig/Fig2_7.png
	:align: center

	Fig 2.7  Retargetablity
...
.. figure:: ../Fig/Fig2_8.png
	:align: center

	Fig 2.8  Simplified x86 Target Definition
...
I put my llvm3.1 source code in /usr/local/llvm/3.1/src and have llvm3.1 release-build in /usr/local/llvm/3.1/configure_release_build. About how to build llvm, please refer http://clang.llvm.org/get_started.html. I made a copy from /usr/local/llvm/3.1/src to /usr/local/llvm/3.1.test/cpu0/1/src for working with my Cpu0 target back end. Sub-directories src is for source code and cmake_debug_build is for debug build directory.
	Except directory src/lib/Target/Cpu0, there are a couple of files modified to support cpu0 new Target. Please check files in src_files_modify/src/. You can search cpu0 without case sensitive to find the modified files by command,
...
The “llc -version” can display “cpu0” and “cpu0el” message, because the following code from file TargetInfo/Cpu0TargetInfo.cpp what in section Target Registration we made. List them as follows again,
