...
.. figure:: ../Fig/Fig3_1.png
	:align: center

	Fig 3.1  TargetMachine class diagram 1
...
Fig 3.2 as below shows Cpu0TargetMachine contains class TSInfo: Cpu0SelectionDAGInfo, FrameLowering: Cpu0FrameLowering, Subtarget: Cpu0Subtarget and TLInfo: Cpu0TargetLowering.

.. figure:: ../Fig/Fig3_2.png
	:align: center

	Fig 3.2  TargetMachine class diagram 2

.. figure:: ../Fig/Fig3_3.png
	:align: center

	Fig 3.3  TargetMachine members and operators
...
.. figure:: ../Fig/Fig3_4.png
	:align: center

	Fig 3.4  Other class members and operators
...
.. figure:: ../Fig/Fig3_7.png
	:align: center

	Fig 3.7  IR and it's corresponding machine instruction

For machine instruction selection, the better solution is represent IR and machine instruction by DAG. In Fig 3.7, we skip the register leaf. The rj + rk is IR DAG representation (for symbol notation, not llvm SSA form). ADD is machine instruction.

.. figure:: ../Fig/Fig3_8.png
	:align: center

	Fig 3.8  Instruction DAG representation
...
.. figure:: ../Fig/Fig3_9.png
	:align: center

	Fig 3.9  Addressing of a variable a located on the stack. If the stack frame has a variable size, slot must be addressed relative to the frame pointer
