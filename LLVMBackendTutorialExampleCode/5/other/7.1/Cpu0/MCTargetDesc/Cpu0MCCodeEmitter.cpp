...
getMachineOpValue(const MCInst &MI, const MCOperand &MO,
  ...
  case MCSymbolRefExpr::VK_Cpu0_GOT:
    ...
    break;
  case MCSymbolRefExpr::VK_Cpu0_ABS:
  ...
  case MCSymbolRefExpr::VK_Cpu0_TLSLDM:
    ...
    break;
  case MCSymbolRefExpr::VK_Cpu0_DTPREL_HI:
    FixupKind = Cpu0::fixup_Cpu0_DTPREL_HI;
    break;
  case MCSymbolRefExpr::VK_Cpu0_DTPREL_LO:
    FixupKind = Cpu0::fixup_Cpu0_DTPREL_LO;
    break;
  case MCSymbolRefExpr::VK_Cpu0_GOTTPREL:
    FixupKind = Cpu0::fixup_Cpu0_GOTTPREL;
    break;
  case MCSymbolRefExpr::VK_Cpu0_TPREL_HI:
    FixupKind = Cpu0::fixup_Cpu0_TPREL_HI;
    break;
  case MCSymbolRefExpr::VK_Cpu0_TPREL_LO:
    FixupKind = Cpu0::fixup_Cpu0_TPREL_LO;
    break;
  default:
    break;
  } // switch
...
unsigned
Cpu0MCCodeEmitter::getSizeExtEncoding(const MCInst &MI, unsigned OpNo,
                                      SmallVectorImpl<MCFixup> &Fixups) const {
...
//
unsigned
Cpu0MCCodeEmitter::getSizeInsEncoding(const MCInst &MI, unsigned OpNo,
                                      SmallVectorImpl<MCFixup> &Fixups) const {
