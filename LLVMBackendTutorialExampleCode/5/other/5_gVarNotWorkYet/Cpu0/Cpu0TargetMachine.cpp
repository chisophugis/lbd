...
extern "C" void LLVMInitializeCpu0Target() {
  // Register the target.
  RegisterTargetMachine<Cpu0ebTargetMachine> X(TheCpu0Target);	//- Big endian Target Machine
  RegisterTargetMachine<Cpu0elTargetMachine> Y(TheCpu0elTarget);	//- Little endian Target Machine
}
...
Cpu0TargetMachine(const Target &T, StringRef TT,
                  ...
                  CodeGenOpt::Level OL,
                  bool isLittle)
  : LLVMTargetMachine(T, TT, CPU, FS, Options, RM, CM, OL),	//- Default is big endian
...
bool Cpu0PassConfig::addPreSched2() {
  PM->add(createCpu0ExpandPseudoPass(getCpu0TargetMachine()));
  return true;
}
