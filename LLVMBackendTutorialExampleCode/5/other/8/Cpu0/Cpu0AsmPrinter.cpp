...
void Cpu0AsmPrinter::EmitFunctionBodyStart() {
  ...
  if (OutStreamer.hasRawTextSupport()) {
    ...
    if (EmitCPLoad)
	//- .cpload	$gp
      OutStreamer.EmitRawText(StringRef("\t.cpload\t$gp"));
	//- .cpload	$10
    //  OutStreamer.EmitRawText(StringRef("\t.cpload\t$10"));
...
bool Cpu0AsmPrinter::isBlockOnlyReachableByFallthrough(const MachineBasicBlock*
                                                       MBB) const {
...
bool Cpu0AsmPrinter::PrintAsmOperand(const MachineInstr *MI, unsigned OpNo,
...
bool Cpu0AsmPrinter::PrintAsmMemoryOperand(const MachineInstr *MI,
  ...
  O << "0($" << Cpu0InstPrinter::getRegisterName(MO.getReg()) << ")";
  return false;
}
...
void Cpu0AsmPrinter::printOperand(const MachineInstr *MI, int opNum,
  ...
  case Cpu0II::MO_ABS:      O << "(";        break;
  case Cpu0II::MO_TLSGD:    O << "%tlsgd(";  break;
  case Cpu0II::MO_GOTTPREL: O << "%gottprel("; break;
  case Cpu0II::MO_TPREL_HI: O << "%tprel_hi("; break;
  case Cpu0II::MO_TPREL_LO: O << "%tprel_lo("; break;
  case Cpu0II::MO_GPOFF_HI: O << "%hi(%neg(%gp_rel("; break;
  case Cpu0II::MO_GPOFF_LO: O << "%lo(%neg(%gp_rel("; break;
  case Cpu0II::MO_GOT_DISP: O << "%got_disp("; break;
  case Cpu0II::MO_GOT_PAGE: O << "%got_page("; break;
  case Cpu0II::MO_GOT_OFST: O << "%got_ofst("; break;
  }
