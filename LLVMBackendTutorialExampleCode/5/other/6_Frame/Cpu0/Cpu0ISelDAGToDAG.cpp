...
SelectAddr(SDNode *Parent, SDValue Addr, SDValue &Base, SDValue &Offset) {
  if (Addr.getOpcode() == ISD::ADD || Addr.getOpcode() == ISD::Constant) {
      int isd0 = Addr.getOpcode();	// Gamma debug
  }
  ...
  int isd1 = ISD::Constant;	// 10
  int isd2 = ISD::GlobalAddress;	// 12
  int isd3 = ISD::ADD;	// 47
  int isd4 = Cpu0ISD::Hi;	// 187
  int isd5 = Cpu0ISD::Lo;	// 188
...
SDNode* Cpu0DAGToDAGISel::Select(SDNode *Node) {
  ...
  if (Opcode == ISD::ADD || Opcode == ISD::Constant) {
      int isd0 = Opcode;	// Gamma debug
  }
